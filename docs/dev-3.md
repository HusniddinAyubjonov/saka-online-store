# Разработчик 3 — Контакты + Оплата и доставка + Калькулятор

У тебя самый маленький объём: **3 страницы** + 3 маленькие формы. Всё простое:
текст, картинки, формы. Никакой сложной логики.
